    ...
    <Link href={href}>
      <div
        ...
        hover:text-blue-500 dark:hover:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900 gap-3 transition-colors ${
          isActive ? "bg-blue-200 dark:bg-blue-900 text-blue-900 dark:text-blue-100" : "text-gray-700 dark:text-gray-300"
        }
      }`}
      >
  ...
  return (
    <div className={sidebarClassNames}>
      ...
      >
        ...
        <button
          className="md:hidden px-3 py-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900 transition-colors duration-300"
      ...
      <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
        <p className="text-center text-xs text-gray-500 dark:text-gray-400">&copy; 2025 Invenio</p>
      </div>
    </div>
  );
};
